...
Modulare Digital Peer Publishing Lizenz (v3, de)
================================================

HTML Version der modularen Digital Peer Publishing Lizenz (Version 3, Deutsch)
...
Das Internet hat die Rahmenbedingungen wissenschaftlichen Arbeitens
tiefgreifend verändert. Dokumente sind in unübe­rschaubarer Menge in
...
regel­mäßig an der weiten, qualitätsvollen Ver­breitung ihrer
Forschungsergebnisse interessiert. Die Modulare DPPL Lizenz gestattet
...
Modularen DPPL Lizenz.

Die modulare DPPL Lizenz bietet die lizenzrechtliche Grundlage für eine
...
und die verwendeten biblio­graphischen Angaben, um eine einheitliche
...
Bedingungen der Modularen DPPL Lizenz verbreitet werden.
...
Abschluss eines Lizenzvertrages dieses Inhalts. Zwischen Lizenzgeber und
Lizenznutzer kommt dadurch ein Vertrag zustande, dass der Nutzer die
...
Modulare DPPL Lizenz pauschal jede Modifizierung der als veränderbar
gekenn­zeichneten Teile des Werks gestattet. Um die Persönlichkeitsrechte
...
In diesem Lizenzvertrag werden die nach­folgend definierten Begriffe
...
Document Format (ODP), das Portable Document Format (PDF), DocBook und
...
urheberrechts­schutzfähige Gegenstand (insbesondere Datenbanken und
...
lizenzgebührenfrei.(4) Dieser Lizenzvertrag will die Versorgung mit
authentischen Wissenschaftsinformationen im Internet stärken, aber auch
Änderungen für solche Teile ermöglichen, die der Lizenzgeber als
veränderbare Werkteile gekennzeichnet hat. Deshalb ist die Nutzung
veränderter Versionen des Werkes nur im Rahmen des § 3 gestattet.

§ 3 Veränderung
~~~~~~~~~~~~~~~

(1) Sie dürfen die veränderbaren Werkteile in beliebiger Weise
...
(3) Sie dürfen das Werk gem. § 10 mit anderen Inhalten in der Weise
verbinden, dass jedes Werk weiterhin selbständig verwertbar bleibt (z.
B. Kombination von Foto und Text).

Abschnitt 3: Nutzungsmodalitäten
--------------------------------

§ 4: Keine Pflicht zur unentgeltlichen Weitergabe
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Dieser Lizenzvertrag verpflichtet Sie nicht, die Nutzung des Werkes
unentgeltlich durchzuführen. Für den Zugang zu dem Werk oder die
Verschaffung eines Verviel­fältigungsstücks durch die elektronische
...
(1) Wenn Sie das Werk nutzen, dürfen Sie die weitere Nutzung durch
Dritte nicht mittels technischer Schutzmaßnahmen, insbesondere durch den
Einsatz von Kopierschutz­vorrichtungen jeglicher Art, verhindern oder
...
von Urhebern - Urheber- oder Copyright­vermerke - in der vorgefundenen
Art und Weise übernehmen. Gleiches gilt für die Nennung der Inhaber
eines ausschließlichen Nutzungsrechts, sofern diese im Zusammen­hang mit
dem Werk genannt werden.
...
geeigneter Weise auf die ursprünglichen Urheber hinweisen, z. B. durch
...
ausschließlichen Nutzungs­rechts den nicht veränderbaren Werkteilen
...
(1) Um trotz der möglichen dezentralen elektronischen Nutzung eine
...
Fundstelle (insbesondere die vollständige Internet­adresse) angeben, an
...
(1) Wenn Sie das Werk in veränderter Weise nutzen, so müssen Sie die
kostenfreie Nutzung des gesamten veränderten Werks nach den Bestimmungen
der Modularen DPPL Lizenz durch jedermann gestatten.

(2) Sollte es sich bei denen von Ihnen hinzugefügten Werkteilen um ein
neues, selbständiges Werk handeln, welches auch isoliert selbständig
verwertet werden kann, so können Sie dieses neue Werk auch unter den
Bedingungen einer anderen Lizenz gemeinsam mit dem ursprünglichen Werk
nutzen.

(3) Wenn Sie das Werk in Kombination mit einem anderen Inhalt nutzen
möchten, der unter einer Creative Commons-Lizenz oder der GNU Free
Documentation License lizenziert ist, so ist dies unter den in § 10
geregelten Bedingungen gestattet.

§ 9: Mitlieferung weiterer Informationen
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

(1) Wenn Sie Nutzungshandlungen vornehmen, die Ihnen aufgrund dieses
...
Download aus dem Internet. Der Lizenztext ist im
`Internet <resolveuid/05cb31a0f8ba42bf8dfc7e87c08f9833>`__ abrufbar.
...
§ 10: Kombination mit anderen Inhalten
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
entfernen und müssen die Lizenzbedingungen für den anderen Inhalt
beachten.

(4) Wenn Sie veränderbare Werkteile mit einem anderen Inhalt, der unter
der Creative Commons-Lizenz "Namensnennung" ("Attribution") genutzt
werden darf, für eine gemeinsame Nutzung verbinden, bei der das Werk und
der andere Inhalt nicht mehr selbständig verwertbar sind (z. B. Einfügen
von Text in einen anderen Text), müssen Sie die lizenzgebührenfreie
Nutzung des gesamten veränderten Werks nach den Bestimmungen der
Modularen DPPL Lizenz durch jedermann gestatten und zusätzlich die
Lizenzbedingungen der Creative Commons-Lizenz beachten.
...
Dieser Lizenztext ist ein Angebot an Sie, das auf den Abschluss eines
...
§ 12: Heimfall der Nutzungsrechte
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

(1) Wenn Sie die in den §§ 2-10 dieses Vertrages genannten
...
§ 13: Vorbehalt der gesetzlichen Rechte
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

(1) Gegenstand dieser Lizenz ist ausschließlich die Einräumung von
...
Wahrnehmung dieser Befugnisse bedarf es nicht des Abschlusses dieses
Lizenzvertrags.
...
Die Haftung des Lizenzgebers Ihnen gegenüber beschränkt sich auf das
arglistige Verschweigen von Mängeln.

§ 15 Haftung bei Ansprüchen Dritter
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Werden die Vertragsparteien einzeln oder gemeinsam durch Dritte wegen
...
§ 16 Verhältnis der Sprachversionen
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

Dieser Lizenzvertrag ist in deutscher und englischer Sprache abgefasst.
...
§ 17 Neue Versionen des Lizenzvertrags
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

(1) Das Ministerium für Innovation, Wissenschaft, Forschung und
...
im `Internet <resolveuid/973b60efcef64fa7b710ad63f289a5dc>`__ mit einer
...
Um jedermann den Abschluss dieses Lizenzvertrages zu ermöglichen, wird
empfohlen, das Werk mit folgendem Hinweis auf den Lizenzvertrag zu
versehen:

"Jedermann darf dieses Werk unter den Bedingungen der Modularen DPPL
...
`Internet <resolveuid/50358bf3b81f9c315c38068f04c33f5f>`__ abrufbar.
